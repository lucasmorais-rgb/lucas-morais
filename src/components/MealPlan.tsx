    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-white">Plano Alimentar Personalizado</h3>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-3xl font-bold text-green-400">{totalCalories}</div>
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-purple-400">115g</div>
          ...
          <div className="bg-slate-900 rounded-2xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-white/10 rounded-xl p-4 text-center">
                <div className="text-2xl font-bold text-white">{selectedMeal.calories}</div>
              ...
              <div className="bg-white/10 rounded-xl p-4 text-center">
                <div className="text-2xl font-bold text-purple-400">{selectedMeal.fat}g</div>
                <div className="text-gray-300 text-sm">Gorduras</div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-3">Modo de Preparo</h3>
                <p className="text-gray-300 leading-relaxed">{selectedMeal.preparation}</p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-white mb-3">Dicas Importantes</h3>
                <ul className="space-y-2">
