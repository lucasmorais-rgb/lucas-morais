      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center items-center gap-2 mb-4">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-white">Seu Corpo Ideal</h1>
          </div>
          <p className="text-gray-300 text-sm sm:text-base">Transforme sua vida com IA personalizada</p>
        </div>
          ...
          {step === 1 && (
            <div className="space-y-4">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-white">Vamos começar!</h2>
          ...
          {step === 2 && (
            <div className="space-y-4">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-white">Dados Corporais</h2>
          ...
          {step === 3 && (
            <div className="space-y-4">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-white">Nível de Atividade</h2>
          ...
          {step === 4 && (
            <div className="space-y-4">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-white">Seu Objetivo</h2>
